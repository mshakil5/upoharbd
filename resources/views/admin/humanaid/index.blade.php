                                      ...
                                      <div class="col-lg-6">
                                        ...
                                        <div>
                                            ...
                                            <select  id="category" name="category" class="form-control">
                                                ...
                                                <option value="ঢেউটিন">ঢেউটিন</option>
                                                <option value="নগদ অর্থ">নগদ অর্থ</option>
                                                <option value="খাদ্যশস্য">খাদ্যশস্য</option>
                                                <option value="কম্বল">কম্বল</option>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td style="text-align: center">
                                                  @if ($data->document)
                                                  <a href="{{route('help.download', $data->id)}}" class="btn btn-success"> Download</a>
                                                  @endif
                                              </td>
